  ...
  return (
    <div>
      ...
      <Box w="70%" margin="auto">
        ...
        <Text fontSize="15px" textAlign="left" mt="1">
          Drive-Mate allows you to hire a rental or self-drive car of your choice
          ...
          use Drive-Mate to pick the car that is suited for your needs. For
          ...
          the city. Drive-Mate provides you with the joy of driving a car, without
        ...
        <Text fontSize="15px" textAlign="left" mt="1">
          Drive-Mate provides you with a car on rent in {location!=="" ? location : "BANGLORE"} without a driver.
          Book your car conveniently through online booking or on your
          smartphone. The vehicles have all-India permits, and Drive-Mate provides
        ...
        <Text fontSize="15px" textAlign="left" mt="1">
          ...
          breakdowns! Drive-Mate has enabled driving convenience for travellers
          ...
          Mysore, Pune, Siliguri and Vizag. Self-drive cars from Drive-Mate have
          given customers more control, privacy, and freedom. Book a self-drive
          car in any city you visit with the Drive-Mate app on your phone and feel
      ...
      <Box>
        ...
        m="5"
          ...
          alt="Drive-Mate'Travel the way you want'"
          maxH="200px"
        />
      </Box>
      <Text align="center" mt="5" mb="2" fontSize="12px">
        © Copyright 2022 Drive-Mate India Private Ltd. All rights reserved
      </Text>
    </div>
  );
}
