        ...
        <>
            <Box margin="auto">
                ...
                >
                    ...
                    >
                        <Text fontSize="2.5vw" fontWeight="500">
                            Inspiring Profitable Mobility Solutions of Tomorrow
                        </Text>
                    </Box>

                    <Box width="60%" margin="auto">
                        <Text fontSize="1.2vw">
                            Suite of Connected Technology Offerings and Connected Mobility Solutions for Businesses Worldwide
                        </Text>
                    </Box>
                ...
                <Box>
                    ...
                    bgColor="#F5F5F5" borderRadius="8px">
                        <Box width="85%" height="70px" margin="auto" borderRadius="5px"
                        border='solid #FFFFFF 1px' 
                        marginTop="-35px" bgColor="#FFFFFF" padding="3px">
                            <Flex gap={2}>
                                <Button w="50%" position="-moz-initial" height="60px" colorScheme='(16,163,16)' size='lg' fontSize="1.2vw"
                                // bgColor="#10a310" 
                                style={{
                                    backgroundColor: `${btnclr1}`,
                                    color: `${clrtxt1}`
                                }}
                                onClick={handleClick}
                                >
                                   <Text>Connected Vehicle Solutions</Text> 
                                </Button>
                                <Button w="50%" position="-moz-initial" height="60px" colorScheme='(16,163,16)' size='lg'  fontSize="1.2vw"
                                // bgColor="#FFFFFF"
                                // color="black" 
                                ...
                                onClick={handleClick}
                                >
                                    <Text>Yield Management Services</Text>
                                </Button>
                            </Flex>
                        </Box>
                        ...
                        // border='solid red 1px' 
                        marginTop="40px" >
                            { aeroplane ? <Text color="#666666">
                                All-in-one solution to reduce operating costs over 30% via advanced vehicle monitoring and management systems
                            </Text>
                            : 
                            <Text color="#666666">
                                Suite of connected technologies offering fleet agnostic solutions aimed at driving higher revenue through better yield management and dual fleet utilisation to expand customer base
                                </Text>}
                        </Box>
                        ...
                        marginTop="40px" >
                            ...
                            :
                            <Img width="100%" src="https://www.zoomcar.com/assets/component-images/ZMS_Slide-Banner_201_F.c6cae2c0c2d78e980c507982bab4c1b9.jpg" alt="logo" />
                            }
                        </Box>

                        <Box width="13%" 
                        // border='solid red 1px' 
                        marginTop="40px" marginLeft="25px">
                        ...
                        <Box w="95%" margin="auto" marginTop="40px">
                            <SimpleGrid columns={[1, 2, 3, 3]} spacing={5} textAlign="start" >
                                ...
                                <Box height="120px" margin="auto" padding="10px"
                                // border='solid red 1px' 
                                >
                        ...
                        <Box width="20%" 
                        // border='solid red 1px' 
                        marginTop="40px" marginLeft="25px" marginBottom="40px">
                ...
                <Box width="100%" height="500px" margin="auto" border='solid #10a310 1px' marginTop="100px" bgColor="#10a310" >
                    <Box marginTop="60px">
                        <Text fontSize="2.4vw" fontWeight="600" color="white">Why Partner with Us?</Text>
                    </Box>

                    <Box width="80%" margin="auto" border='solid #F5F5F5 1px' marginTop="60px" bgColor="#F5F5F5" >
                        <Box w="95%" margin="auto" marginTop="40px" marginBottom="50px">
                            <SimpleGrid columns={[1, 2, 3, 3]} spacing={5} textAlign="start" >

                                <Box height="220px" margin="auto" 
                                // border='solid red 1px' 
                                padding="10px">
                ...
                <Box width="80%" margin="auto" border='solid white 1px' marginTop="530px" >
                    <Img src="https://www.zoomcar.com/assets/component-images/dashboard@2x.a2445440373cd84df21b0d887b8d389f.png" alt="logo" />
                </Box>

                <Box width="80%" margin="auto" border='solid #F5F5F5 1px' bgColor="#F5F5F5" marginTop="-220px" >
                    <Box marginTop="240px">
                    ...
                    <Box w="40%" margin="auto" marginTop="40px">
                        <SimpleGrid columns={[1, 2, 2, 2]} spacing={5} textAlign="start" >
                            ...
                            <Box height="260px" margin="auto" 
                            // border='solid red 1px' 
                            padding="10px" bgColor="black">
                            ...
                            <Box height="260px" margin="auto" border='solid black 1px' padding="10px" bgColor="black">
                    ...
                    <Box width="100%" margin="auto" bgColor="white" border='solid white 1px' marginTop="-360px" >
                        ...
                        <Box width="40%" margin="auto" bgColor="white" border='solid white 1px' marginTop="20px" marginBottom="270px">
                ...
                <Box width="100%" height="400px" margin="auto" bgColor="black" border='solid black 1px'>
                    ...
                    <Box marginTop="10px" fontSize="1.2vw" >
                        <Text color="#A8A8A8">ⓒ 2024 Drive-Mate | All Rights Reserved</Text>
                    </Box>
                </Box>
            </Box>
        </>
